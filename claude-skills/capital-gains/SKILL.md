...
- **50% CGT discount:** applies to individuals (and trusts) who held the asset for **more than 12 months** measured to the contract date of sale. Companies do **not** get the 50% discount — flag if the owner is a company. If held ≤ 12 months, use the full gross gain (no discount).
